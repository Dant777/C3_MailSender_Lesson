...
namespace MailSender_Lib
{
    ...
    public class EmailSendServiceClass_Test
    {
        ...
        public EmailSendServiceClass_Test(string senderName, string senderAddress, string recipientName, string recipientAddress)
        {
